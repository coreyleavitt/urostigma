...
- [ ] 9 CI: build + test (Apps build-only pass; pin+OS+SDK cache keys) (in progress: delegated agent authors workflow + local dry-run; Actions-green verification by control loop after push)
